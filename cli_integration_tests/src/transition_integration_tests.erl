...
integration_test_() ->
    integration_tests_common:create_tests_entry([
        {"transition: execute unsuitable command",
         ["login", "root", "iddqd", "no name", "logout", "bye"],
        ...
        {"transition: enter into interface configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface someinterface 0/1", "logout", "bye"],
        ...
        {"transition: enter into interface range configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface range someinterface 0/1,3-5", "logout", "bye"],
        ...
        {"transition: enter into vlan configuration mode",
         ["login", "root", "iddqd", "configure terminal", "vlan 666", "logout", "bye"],
        ...
        {"transition: exit from interface configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface someinterface 0/1", "exit", "logout", "bye"],
        ...
        {"transition: exit from interface range configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface range someinterface 0/1,3-5", "exit", "logout", "bye"],
        ...
        {"transition: exit from vlan configuration mode",
         ["login", "root", "iddqd", "configure terminal", "vlan 666", "exit", "logout", "bye"],
        ...
        {"transition: end interface configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface someinterface 0/1", "end", "logout", "bye"],
        ...
        {"transition: end interface range configuration mode",
         ["login", "root", "iddqd", "configure terminal", "interface range someinterface 0/1,3-5", "end", "logout", "bye"],
