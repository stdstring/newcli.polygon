...
integration_test_() ->
    integration_tests_common:create_tests_entry([
        ...
        {"transition: enter into interface configuration mode",
         ["root", "iddqd", "configure terminal", "interface someinterface 0/1", "end", "logout"],
         ?ADMIN_LOGIN ++ [?GREETING, ?CONFIG_TERM, ?INTERFACE] ++ ?INTERFACE_LOGOUT},
        {"transition: enter into interface range configuration mode",
         ["root", "iddqd", "configure terminal", "interface range someinterface 0/1,3-5", "end", "logout"],
         ?ADMIN_LOGIN ++ [?GREETING, ?CONFIG_TERM, ?INTERFACE_RANGE] ++ ?IRANGE_LOGOUT},
        {"transition: enter into vlan configuration mode",
         ["root", "iddqd", "configure terminal", "vlan 666", "end", "logout"],
         ?ADMIN_LOGIN ++ [?GREETING, ?CONFIG_TERM, ?VLAN] ++ ?VLAN_LOGOUT},
        {"transition: exit from interface configuration mode",
         ["root", "iddqd", "configure terminal", "interface someinterface 0/1", "exit", "end", "logout"],
        ...
        {"transition: exit from interface range configuration mode",
         ["root", "iddqd", "configure terminal", "interface range someinterface 0/1,3-5", "exit", "end", "logout"],
        ...
        {"transition: exit from vlan configuration mode",
         ["root", "iddqd", "configure terminal", "vlan 666", "exit", "end", "logout"],
