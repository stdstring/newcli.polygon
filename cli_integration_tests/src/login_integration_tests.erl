...
-define(BAD_PASSWORD, "Login's attempt is failed due to the following: {authentication_fail,bad_password}").
-define(UNKNOWN_USER, "Login's attempt is failed due to the following: {authentication_fail,unknown_username}").
