...
get_help() -> "name {name-string} command".
...
-spec start_command(CommandLineRest :: string(), Stdout :: pid(), Stderr  :: pid()) -> pid() | {'name_vlan_command', Error :: term()}.
