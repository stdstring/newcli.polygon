...
-module(interface_range_command).
...
-define(COMMAND, interface_range_command).
...
get_help() -> "interface range {interface-list} command".
...
-spec start_command(CommandLineRest :: string(), Stdout :: pid(), Stderr  :: pid()) -> pid() | {'interface_range_command', Error :: term()}.
