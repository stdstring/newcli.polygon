...
-module(no_switchport_vlan_command).
...
-define(COMMAND, no_switchport_vlan_command).
...
-spec start_command(Stdout :: pid(), Stderr  :: pid()) -> pid() | {'no_switchport_vlan_command', Error :: term()}.
